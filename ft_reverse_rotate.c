...
/*   Updated: 2023/05/30 10:58:51 by wnaiji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_rra(t_list *stack_a)
{
	if (!stack_a || stack_a->next == NULL)
		return (stack_a);
	stack_a = ft_add_front_list(stack_a, ft_last_content(stack_a), \
				ft_last_index(stack_a));
...
t_list	*ft_rrb(t_list *stack_b)
{
	if (!stack_b || stack_b->next == NULL)
		return (stack_b);
	stack_b = ft_add_front_list(stack_b, ft_last_content(stack_b), \
				ft_last_index(stack_b));

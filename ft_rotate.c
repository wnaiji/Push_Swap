...
/*   Updated: 2023/05/20 14:32:44 by wnaiji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_ra(t_list *stack_a)
{
	if (!stack_a || stack_a->next == NULL)
		return (stack_a);
	ft_add_back_list(stack_a, stack_a->content);
...
t_list	*ft_rb(t_list *stack_b)
{
	if (!stack_b || stack_b->next == NULL)
		return (stack_b);
	ft_add_back_list(stack_b, stack_b->content);
...
t_list	*ft_rr(t_list *stack_a, t_list **stack_b)
{
	...
	if ((!stack_a || stack_a->next == NULL)
		...
		return (stack_a);
	ft_add_back_list(stack_a, stack_a->content);
	ft_add_back_list(*stack_b, tmp->content);
	stack_a = ft_delete_in_head(stack_a);
	*stack_b = ft_delete_in_head(*stack_b);
	ft_putstr("rr\n");
	return (stack_a);
